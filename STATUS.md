...
_Last refresh: 2026-04-28T21:05:14.120Z (just now)_
...
- `4325753` — chore(dashboard): refresh state 2026-04-28T21:00:47Z · 4m ago
- `773784e` — chore(dashboard): refresh state 2026-04-28T20:55:08Z · 10m ago
- `960969c` — fix(dashboard): add set -x diagnostics to git steps; EAS auth-only errors · 11m ago
- `ca4852a` — chore(dashboard): refresh state 2026-04-28T20:53:53Z · 11m ago
- `afb13d5` — chore(dashboard): refresh state 2026-04-28T20:49:17Z · 16m ago
- `72b7671` — fix(dashboard): bulletproof commit step with cp/hard-reset; treat EAS no-updates as healthy · 17m ago
- `13f0ca2` — chore(dashboard): refresh state 2026-04-28T20:44:32Z · 21m ago
- `3f0ae5e` — fix(dashboard): fetch+reset instead of rebase to avoid state.json conflicts; fix push trigger branch to master · 22m ago
- `e78db7b` — fix(dashboard): auto-detect repo default_branch instead of hardcoded main · 31m ago
- `9eb4251` — fix(dashboard): use configurable GH_BRANCH (default master) for commits+CI queries · 36m ago

## CDN probes

- OK  `jsdelivr` — 200 · 124ms
- OK  `rawGithub` — 200 · 159ms
- OK  `everyayah` — 200 · 532ms
- OK  `quranicaudio` — 200 · 398ms
- OK  `qurancdn` — 200 · 359ms
